...
const server = app.listen(PORT, () => {
  ...
  const routes = [
    ...
    'POST /api/auth/apple - Sign in with Apple OAuth',
    ...
    'GET  /api/designs/user/designs - Get user\'s designs with pagination',
    'GET  /api/checkout/user/orders - Get user\'s orders with pagination',
